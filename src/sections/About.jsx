...
const About = () => {
  return (
    <section id="about" className="py-20 px-6 max-w-6xl mx-auto">
      ...
      <div className="mb-16">
        <h2 data-reveal className="text-2xl font-bold mb-8 text-primary dark:text-white">Education</h2>
        
        <div className="space-y-8">
          {EDUCATION.map((edu, idx) => (
            <div key={idx} data-reveal className="border-l-2 border-neutral-100 dark:border-neutral-800 pl-6 relative">
      ...
      <div>
        <h2 data-reveal className="text-2xl font-bold mb-8 text-primary dark:text-white">Tech Stack</h2>
